...
def create_callbacks(training_model, prediction_model, validation_generator, args):
    ...
    if args.snapshots:
        ...
        checkpoint = keras.callbacks.ModelCheckpoint(
            os.path.join(
                args.snapshot_path,
                f'{args.dataset_type}_{args.start_epoch}_{{epoch:02d}}_{{loss:.4f}}_{{val_loss:.4f}}.h5' if args.compute_val_loss
...
def parse_args(args):
    ...
    parser.add_argument('--start-epoch', help='Starting epoch for saving weights.', type=int, default=0)
